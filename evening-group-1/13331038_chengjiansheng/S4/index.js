...
(function(){
  var s4RobotClickInRandom, s3RobotClickInTheSameTime, Robot, Button, addClickingHandlerToAllButtons, addResettingWhenLeaveApb, addClickingHandlerToTheBubble;
  $(function(){
    ...
    return s4RobotClickInRandom();
  });
  s4RobotClickInRandom = function(){
  ...
  s3RobotClickInTheSameTime = function(){
    $('#button .apb').click(function(){
      if (Robot.state === 'unclicked') {
        Robot.clickAtTheSameTime();
      }
    });
  };
  Robot = (function(){
    ...
    Robot.clickAtTheSameTime = function(){
      var i$, ref$, len$, dom;
