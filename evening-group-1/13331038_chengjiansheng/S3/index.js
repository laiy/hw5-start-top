...
(function(){
  var s3RobotClickInTheSameTime, Robot, Button, addClickingHandlerToAllButtons, addResettingWhenLeaveApb, addClickingHandlerToTheBubble;
  $(function(){
    addClickingHandlerToAllButtons(function(){
      Robot.clickInTheSameTime();
    });
    addClickingHandlerToTheBubble();
    addResettingWhenLeaveApb();
    return s3RobotClickInTheSameTime();
  });
